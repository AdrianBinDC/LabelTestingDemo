...
class CurrencyFormatter {
    func formatAsCurrency(amount: Float, currencyCode: CurrencyCode) -> String? {
        let intValue = NSNumber(value: amount)
        ...
        return numberFormatter.string(from: intValue)
    }
}
